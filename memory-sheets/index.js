...
function showAbout() {
    ...
    var content = cde("div.modal-content", [
        ...
        cde("p", ["Alternatively, make an issue or create a pull request on ", cde("a", {href: "https://github.com/amrugg/bb-printables", t: "my github page."})]),
                    cde("p", ["Other tools I have made include ", cde("a", {href: "https://bibleadventure.com/memorySchedule/", t: "Memory Schedule"}), ", ", cde("a", {href: "https://amrugg.github.io/bb-printables/flashcards/", t: "Flash Card Generator"}), ", and ", cde("a", {href: "https://scriptureleague.org/reference-recall/", t: "Reference Recall"}), "."]),
        cde("p", ["~ Aaron Rugg"])
    ]);
